#
# Sample code from the executorch docs.
# Use this to validate that the virtual environment is set up correctly.
#
import torch
...
# TODO: Move this into the package as a runnable example
